...
fun NormalOpenAPIRoute.budget() {
    route("/budget") {
        route("/add").post<Unit, BudgetRecord<AuthorResponse>, BudgetRecord<AuthorIdRequest>>(info("Добавить запись")) { param, body ->
...
data class BudgetRecord<T: AuthorRecord>(
...
class BudgetYearStatsResponse(
    ...
    val items: List<BudgetRecord<AuthorResponse>>
)
